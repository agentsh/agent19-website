        ...
        if (this.props.animationProgress > 3 * this.progressStep) {
            ...
            slide = (
                <SlideTitle animationProgress={this.props.animationProgress} progressStep={this.progressStep}>
                    ...
                    <h3>Dornbirn FH-Vorarlberg, Lech</h3>
                </SlideTitle>
            );
            ...
            slide = (
                <SlideTitle animationProgress={this.props.animationProgress} progressStep={this.progressStep}>
                    ...
                    <h2>
                        Experts and industry leaders come together to showcase their work in ReactJS, React Native and
                        more
                    </h2>
                </SlideTitle>
            );
...
class CitySlide extends React.PureComponent {
    ...
    render() {
        ...
        if (this.props.animationProgress > 2 * this.progressStep) {
            ...
            slideTitleContainer = (
                <SlideTitle animationProgress={this.props.animationProgress} progressStep={this.progressStep}>
                    <h2>FH-Vorarlberg, Dornbirn, Austria</h2>
                </SlideTitle>
            );
        } else {
            // empty slide
